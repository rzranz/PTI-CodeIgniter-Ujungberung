            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                  ...
                  <div class="icon">
                    <i class="ion ion-android-checkboxoutline"></i>
                  </div>
                  <a href="<?php echo site_url('model'); ?>" class="small-box-footer">
                    More info <i class="fa fa-arrow-circleright"></i>
                  </a>
                </div>
              </div><!-- ./col -->
              <div class="col-lg-3 col-xs-6">
            ...
            <section class="col-lg-12 connectedSortable" style="margin-top: 2rem">
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  ...
                  <li><a href="#alamat-pabrik" datatoggle="tab">Pabrik</a></li>
                    ...
                    <div class="col-md-10">
                      ...
                      foreach ($user1->result() as $row) { ?>
                        ...
                        <address>
                          ...
                          <i class="fa fainbox"></i><a href="mailto:<?php echo $row->user_email; ?>"> <?php echo
                              $row->user_email; ?></a>
                        </address>
                        <?php
                      }
                    ...
                    <div class="col-md-10">
                      ...
                      foreach ($user2->result() as $row) { ?>
                        <address>
                          ...
                          <?php echo $row->user_alamat; ?><br>
                          <?php echo $row->user_kota; ?>   <?php echo $row->user_kodepos; ?><br>
                          <i class="fa faphone-square"></i> <?php echo $row->user_telepon; ?>
                        </address>
                        <address>
                          <strong><?php
